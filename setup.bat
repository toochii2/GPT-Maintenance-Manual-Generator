@echo off
echo ======================================
echo Maintenance Manual Generator Setup
echo ======================================
echo.
...
echo    - Repository name: maintenance-manual-generator
...
echo    git add .
echo    git commit -m "Initial commit: Maintenance Manual Generator"
echo    git branch -M main
echo    git remote add origin https://github.com/YOURUSERNAME/maintenance-manual-generator.git
...
echo    https://YOURUSERNAME.github.io/maintenance-manual-generator
echo.
